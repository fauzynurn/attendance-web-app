...
export default class Mahasiswa extends Component {
  ...
  render() {
    return (
      ...
      <Divider type="vertical"/>
      <Cascader options={options} onChange={this.onKelasChanged} placeholder="Please select a class" />
      <Divider type="vertical"/>
      <Button type="primary" shape="round" icon="search" onClick={this.onClickSearch}/>
      <Divider/>
